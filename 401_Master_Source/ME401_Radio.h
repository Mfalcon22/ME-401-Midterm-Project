#ifndef _ME401_RADIO_H
#define _ME401_RADIO_H
...
void updateRobotPoseAndBallPositions (void)
{
  ...
  // TODO: read from the radio to get a packet
...
// TODO: Create and ISR the is running at about 20 HZ, reading in the packets. This ISR should do the following
//   (1) Read packets until a $ is found
//   (2) read packets until a * is found
//   (3) copy the data into the current double-buffer memory locations 
//   (4) repeat 
// NOTE: We are doing it this way so that the ISR is never taking the time to interpret the data. Instead, it is interpreted when the
//       user calls the function to get the ball positions.
